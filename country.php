...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Master List<i class="fa fa-angle-right"></i>Country</li>
</ol>
...
<div class="validation-system" style="margin-top: 0;">
  ...
  <!---->
        <form method="POST" action="controller/ccity.php?countryedit=<?php echo isset($row['CountryId']) ? $row['CountryId'] : ''; ?>">
        ...
        <h2>Add Country</h2>
            ...
            <div class="col-md-12 form-group">
              ...
              <button type="button" onclick="location.href = 'country.php'" class="btn btn-default">Reset</button>
