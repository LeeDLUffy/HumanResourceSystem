...
<?php
	...
	if(isset($_GET['employeeid']))
	{
		...
		$departmentid = $row['Dptid'];
		$did = mysqli_query($db,"select * from department where departmentid='$departmentid'");
		$departmentn = mysqli_fetch_assoc($did);
...
<div class="validation-form" style="margin-top: 0;">
	<h2 style="text-transform: capitalize; margin: 0px;"><?php if($row) { echo $row['Surname']."&nbsp".$row['Othernames'];} else { echo "Null"; } ?> -&nbsp;&nbsp;<font color="black"><?php if($row>0) { echo "Employee ID :: &nbsp;&nbsp;".$row['EmployeeId']; } else { echo "<b>Employee ID</b> :: &nbsp;&nbsp; Null"; }?></font></h2>
	<div class="row">
		<div class="col-md-5">
			<table>
				<tbody>
				...
				<tbody>
					<tr>
						...
						<td><?php if($row) { echo $row['Address']; } else{ echo "Null"; }?>,</td>
					</tr>
					<tr>
						<td></td>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><?php if($departmentn) { echo ucfirst($departmentn['name']); } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td><?php if($row) { echo $row['Phone No']; } else{ echo "Null"; }?></td>
					</tr>
				</tbody>
			</table>
		</div>
