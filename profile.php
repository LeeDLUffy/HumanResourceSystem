...
<?php
	...
	$did = mysqli_query($db,"select * from department where Dptid='$departmentid'");
...
<div class="validation-form" style="margin-top: 0;">
	<h2 style="text-transform: capitalize; margin: 0px;"><?php if($row) { echo $row['Surname']."&nbsp;".$row['Othernames'];} else { echo "Null"; } ?> -&nbsp;&nbsp;<font color="black"><?php if($row>0) { echo "Employee ID ::&nbsp;".$row['EmployeeId']; } else { echo "<b>Employee ID</b> ::&nbsp; Null"; }?></font></h2>
	<div class="row">
		<div class="col-md-5">
			<table>
				<tbody>
