...
<?php //print_r($_SESSION);exit;
	...
	$departmentid = $_SESSION['User']['Dptid'];
               	...
               	<div class="s-12 l-2">
                 	<table>
                 		<tbody>
                 			...
                 			<tr>
                 				<td align="center"><u style="margin-bottom: 5px;"><b><?php echo ucfirst($_SESSION['User']['Surname'])."&nbsp;".ucfirst($_SESSION['User']['Othernames']); ?></b></u></td>
                 			</tr>
                 			<tr>
                 	...
                 	<table>
                 		<tbody>
                 			...
                 			<tr>
                 				...
                 				<td ><?php echo(isset($_SESSION['User']['Phone No']))?$_SESSION['User']['Phone No']:"Null";?></td>
                 			</tr>
                 			
                 			<tr>
                 				<td style="text-align: right;"><b>Address :</b></td>
                 				<td ><?php echo(isset($_SESSION['User']['Address']))?$_SESSION['User']['Address']:"Null";?> </td>
                 			</tr>
                 			<tr>
                 				<td></td>
                 	...
                 	<table>
                 		<tbody>
							 ...
							 <tr>
                 				...
                 				<td><?php echo(isset($departmentn['name']))?ucfirst($departmentn['name']):"Null";?></td>
                 			</tr>
                 			<tr>
