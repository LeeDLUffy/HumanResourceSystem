...
?>
            <div class="s-12 l-10">
               <h1 style="color: #858282;">Leave Applications</h1><hr>
               ...
               <?php $i=1; while($rom = mysqli_fetch_assoc($leavedetails)) { //print_r($rom);exit;
			      $typeid = $rom['LeavetypeId'];
			      $typename = mysqli_query($db,"select * from leavetype where LeaveId='$typeid' ");
			      $typen = mysqli_fetch_assoc($typename); ?>
        	
	               	<div class="s-12 l-1" style="text-align: center;"><?php $i=$i; echo $i; $i++;?></div>
	               	<div class="s-12 l-2" style="text-align: center;"><?php echo ucfirst((isset($typen['type']))?$typen['type']:""); ?></div>
	               	<div class="s-12 l-3" style="text-align: center;"><?php echo(isset($rom['Reason']))?$rom['Reason']:""; ?></div>
	               	<div class="s-12 l-2" style="text-align: center;"><?php echo(isset($rom['StartDate']))?$rom['StartDate']:""; ?></div>
