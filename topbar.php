        ...
        <div class="left-content">
            <div class="mother-grid-inner">
                ...
                <div class="header-main">
                    <div style="padding: 1.15em; margin-right: 0%; width: 70%; background-color: #21BC10 !important;" class="logo-w3-agile">
                        <h1 class="clas"><a href="index.php">Human Resource System</a></h1>
                    </div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												...
												<div class="user-name">
													<p><?php echo $_SESSION['User']['Surname']."&nbsp;".$_SESSION['User']['Othernames']; ?></p>
