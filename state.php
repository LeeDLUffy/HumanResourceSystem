...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Master List<i class="fa fa-angle-right"></i>County</li>
</ol>
        	...
        	<div class="col-md-3 control-label">
          	...
          	<div class="col-md-3 control-label">
            	<label class="control-label">County</label>
              	...
              	<input type="text" name="state" required="" value="<?php echo $name; ?>" placeholder="County Name" class="form-control" style="width: 250px; height: 35px; float: right;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
